{
  ...
  "is_plant": true,
  "health_assessment": {
    "is_healthy_probability": 0.08732191813746399,
    "is_healthy": false,
    "diseases": [
      {
        "classification": [],
        "name": "Animalia",
        "probability": 0.9338500755999999,
      },
      {
        "classification": ["Animalia"],
        "name": "Insecta",
        "probability": 0.8415332551999999,
      },
      {
        "classification": ["Animalia", "Insecta"],
        "name": "Hemiptera",
        "probability": 0.595081696,
      },
      {
        "classification": ["Animalia", "Insecta", "Hemiptera", "Sternorrhyncha"],
        "name": "Coccoidea",
        "probability": 0.5835658941999999,
      },
      {
        "classification": [],
        "name": "Abiotic",
        "probability": 0.042967240306,
      },
      {
        "classification": ["Abiotic"],
        "name": "Pesticide damage",
        "probability": 0.036413785322,
      },
    ],
    "diseases_simple": [
      {
